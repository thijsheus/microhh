...
#ifndef MICROPHYS_2MOM_CLD_WARM_H
#define MICROPHYS_2MOM_CLD_WARM_H
...
namespace Micro_2mom_cld_warm_constants
{
...
namespace Micro_2mom_cld_warm_functions
{
...
class Microphys_2mom_cld_warm : public Microphys<TF>
{
    public:
        Microphys_2mom_cld_warm(Master&, Grid<TF>&, Fields<TF>&, Input&);
        virtual ~Microphys_2mom_cld_warm();
        void init();
